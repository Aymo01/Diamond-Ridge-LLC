            ...
            >
              ...
              <div className="space-y-6 text-gray-600 text-lg">
                ...
                <motion.p
                  ...
                  className="leading-relaxed"
                >Our team doesn't just bring expertise, we bring <span className="text-gray-900 font-semibold">passion</span>. Every project, from emergency repairs to comprehensive maintenance programs, receives the same level of dedication and precision that's made us the go to choice for Fortune companies and local businesses alike.</motion.p>
                <motion.p
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
